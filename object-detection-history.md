...
---
- ![RPN anchors](asserts/RPN-anchors.png)
---
- ![Multi-scale feature learning](asserts/multi-scale-feature-learning.png)
---
- ![comman-evaluation-metrics](asserts/comman-evaluation-metrics.png)
---
- ![detection result on VOC2007](asserts/detection-result-on-VOC2007.png)
---
- ![detection result on COCO-test-dev](asserts/detection-result-on-COCO-test.png)
